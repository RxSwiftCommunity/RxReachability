...
test:
	xcodebuild test -scheme $(TEST_SCHEME) -workspace  $(WORKSPACE) -destination $(DESTINATION) -parallelizeTargets -showBuildTimingSummary -enableThreadSanitizer YES CODE_SIGN_IDENTITY="" CODE_SIGNING_REQUIRED=NO ONLY_ACTIVE_ARCH=YES | tee xcodebuild.log | xcpretty

#> -- Building --

#> Make a .zip package of frameworks
package:
	carthage build --no-skip-current --platform $(PLATFORM) --use-xcframeworks
